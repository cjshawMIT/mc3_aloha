...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MC3Objectives.parent'
        db.add_column(u'vcb_mc3objectives', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['vcb.MC3Objectives']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MC3Objectives.parent'
        db.delete_column(u'vcb_mc3objectives', 'parent_id')
    ...
    models = {
        ...
        u'vcb.mc3objectives': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['vcb.MC3Objectives']"}),
            'sequence_order': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'})
        },
