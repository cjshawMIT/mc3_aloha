...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClassSessions.is_active'
        db.add_column(u'vcb_classsessions', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'MC3Activities.is_active'
        db.add_column(u'vcb_mc3activities', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Classes.is_active'
        db.add_column(u'vcb_classes', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'MC3Objectives.is_active'
        db.add_column(u'vcb_mc3objectives', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClassSessions.is_active'
        db.delete_column(u'vcb_classsessions', 'is_active')

        # Deleting field 'MC3Activities.is_active'
        db.delete_column(u'vcb_mc3activities', 'is_active')

        # Deleting field 'Classes.is_active'
        db.delete_column(u'vcb_classes', 'is_active')

        # Deleting field 'MC3Objectives.is_active'
        db.delete_column(u'vcb_mc3objectives', 'is_active')
