...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MC3Activities.sequence_order'
        db.add_column(u'vcb_mc3activities', 'sequence_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MC3Activities.sequence_order'
        db.delete_column(u'vcb_mc3activities', 'sequence_order')
