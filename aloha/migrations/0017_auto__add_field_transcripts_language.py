...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transcripts.language'
        db.add_column(u'vcb_transcripts', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en-US', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transcripts.language'
        db.delete_column(u'vcb_transcripts', 'language')
    ...
    models = {
        ...
        u'vcb.clicks': {
            ...
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activity'", 'to': u"orm['vcb.MC3Activities']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
