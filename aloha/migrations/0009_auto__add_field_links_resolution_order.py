...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Links.resolution_order'
        db.add_column(u'vcb_links', 'resolution_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Links.resolution_order'
        db.delete_column(u'vcb_links', 'resolution_order')
    ...
    models = {
        ...
        u'vcb.links': {
            ...
            'resolution_order': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
