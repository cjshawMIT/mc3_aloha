...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Clicks'
        db.create_table(u'vcb_clicks', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vcb.MC3Activities'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'vcb', ['Clicks'])

        # Adding M2M table for field clicks on 'Classes'
        m2m_table_name = db.shorten_name(u'vcb_classes_clicks')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('classes', models.ForeignKey(orm[u'vcb.classes'], null=False)),
            ('clicks', models.ForeignKey(orm[u'vcb.clicks'], null=False))
        ))
        db.create_unique(m2m_table_name, ['classes_id', 'clicks_id'])


    def backwards(self, orm):
        # Deleting model 'Clicks'
        db.delete_table(u'vcb_clicks')

        # Removing M2M table for field clicks on 'Classes'
        db.delete_table(db.shorten_name(u'vcb_classes_clicks'))
