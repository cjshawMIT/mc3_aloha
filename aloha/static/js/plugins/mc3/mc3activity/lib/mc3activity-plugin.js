...
(function() {
  define(['aloha', 'aloha/plugin', 'jquery', 'aloha/ephemera', 'ui/ui', 'ui/button', 'semanticblock/semanticblock-plugin', 'css!../../mc3activity/css/mc3activity-plugin.css'], function(Aloha, Plugin, jQuery, Ephemera, UI, Button, semanticBlock) {
    ...
    return Plugin.create('mc3activity', {
      ...
      activate: function($element) {
        ...
        jQuery('<div>').addClass('body')
                ...
                .aloha()
                .append($body);
        return MC3AUTH.append_outcomes_selector($element);
      },
