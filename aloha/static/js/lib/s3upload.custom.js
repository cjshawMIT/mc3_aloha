...
// (original: https://github.com/tadruj/s3upload-coffee-javascript)
// by
// Cole Shaw, MIT OEIT
// August 2013
...
(function() {
  ...
  window.S3Upload = (function() {
    ...
    S3Upload.prototype.executeOnSignedUrl = function(file, callback) {
      ...
      xhr.onreadystatechange = function(e) {
        ...
        if (this.readyState === 4 && this.status === 200) {
          ...
          var cloudfrontURL = result.cloudfront;
          return callback(result.signed_request, cloudfrontURL);
    ...
    S3Upload.prototype.uploadToS3 = function(file, url, public_url) {
      ...
      // to account for the transcript vtt files (which have type set as ""?):
      if (file.type === "") {
          var send_type = 'text/vtt';
      } else {
          var send_type = file.type;
      }
      xhr.setRequestHeader('Content-Type', send_type);
